...
echo "2. Add required dependencies to the usecase struct"
echo "3. Implement your usecase methods"
echo "4. Register the usecase in your dependency injection setup"
