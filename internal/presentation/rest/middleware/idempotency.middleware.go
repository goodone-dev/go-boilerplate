...
func IdempotencyHandler(cache cache.Cache, duration time.Duration) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var body any
		if err = val.Decode(&body); err == nil && body != nil {
		...
		if len(c.Errors) == 0 && blw.body.String() != "" {
